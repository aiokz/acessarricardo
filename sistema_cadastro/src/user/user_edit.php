        ...
        <form method="post" action="service/process.php" class="m-5" id="myform" autocomplete="off">
            <div class="card-form">
                <div class="inputs">
                    ...
                    <input type="text" name="name" placeholder="Digite o nome completo" value="<?php echo $name  ?>" autocomplete="off">
                </div>
                ...
                <div class="inputs">
                    ...
                    <input type="email" name="email" placeholder="Digite o seu e-mail" value="<?php echo $email ?>" autocomplete="off">
                ...
                <input onclick="changeAction()" class="btn btn-primary" type="submit" value="Atualizar" name="update" >
